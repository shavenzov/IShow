...
//      menu.isPressed = true;
     ...
     *  @productversion Flex 3
     */
    public function show( xShow : Number = 0.0, yShow : Number = 0.0 ) : void
    {
		...
		/*
		Корректируем координаты меню, что-бы оменю всегда было видимым
		*/
		
		var wOverflow : Boolean = ( xShow + width ) > stage.width;
		var hOverflow : Boolean = ( yShow + height ) > stage.height;
