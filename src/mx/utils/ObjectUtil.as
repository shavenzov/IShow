...
public class ObjectUtil
{
    ...
    */
	...
	public static function cloneDictionary( dict : Dictionary ) : Dictionary
	{
	...
	*/
	public static function numDictionaryElements( dict : Dictionary ) : uint
	{
		var result : uint = 0;
		var o      : *;
	...
	/**
	 * Преобразует словарь в массив ( значения словаря становятся значениями массива )
	 * 
	 */	
