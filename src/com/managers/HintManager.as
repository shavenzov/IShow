package com.managers
{
	...
	public class HintManager
	{
		...
		public static function show( data : Object, error : Boolean = false, target : Object = null, mouseInteraction : Boolean = false, time : int = -1, hideOther : Boolean = true ) : HintShell
		{
			if ( hideOther )
			{
				if ( _shells.length > 0 )
