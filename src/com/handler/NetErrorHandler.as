package handler
{
	import com.handler.IChannel;
	import com.handler.RepairDialog;
	...
	public class NetErrorHandler
	{
		...
		public static function processError( channel : IChannel, errorMessage : String, errorCode : String ) : Boolean
		{
			if ( repairing )
			{
			  var i : int = 0;
